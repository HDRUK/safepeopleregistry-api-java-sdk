...
- API version: 1.0.0
  - Build date: 2026-08-18T08:34:20.150560795Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "uk.ac.hdruk.safepeopleregistryapi:safepeopleregistry-api-sdk:1.35.0"
  }
```
...
* `target/safepeopleregistry-api-sdk-1.35.0.jar`
* `target/lib/*.jar`

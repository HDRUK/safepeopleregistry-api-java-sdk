...
- API version: 1.0.0
  - Build date: 2026-08-03T14:11:11.944970577Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "uk.ac.hdruk.safepeopleregistryapi:safepeopleregistry-api-sdk:0.0.0-test1"
  }
```
...
* `target/safepeopleregistry-api-sdk-0.0.0-test1.jar`
* `target/lib/*.jar`

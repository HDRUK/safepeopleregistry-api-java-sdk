...
- API version: 1.0.0
  - Build date: 2026-09-18T14:33:22.735334762Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "uk.ac.hdruk.safepeopleregistryapi:safepeopleregistry-api-sdk:1.36.1"
  }
```
...
* `target/safepeopleregistry-api-sdk-1.36.1.jar`
* `target/lib/*.jar`

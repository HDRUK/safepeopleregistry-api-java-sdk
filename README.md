...
- API version: 1.0.0
  - Build date: 2026-08-05T05:12:22.471719795Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "uk.ac.hdruk.safepeopleregistryapi:safepeopleregistry-api-sdk:0.0.0-test2"
  }
```
...
* `target/safepeopleregistry-api-sdk-0.0.0-test2.jar`
* `target/lib/*.jar`

...
import uk.ac.hdruk.safepeopleregistryapi.auth.Authentication;
import uk.ac.hdruk.safepeopleregistryapi.auth.HttpBasicAuth;
import uk.ac.hdruk.safepeopleregistryapi.auth.HttpBearerAuth;
import uk.ac.hdruk.safepeopleregistryapi.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.0.0-test2/java");
     ...
     * @return a {@link uk.ac.hdruk.safepeopleregistryapi.ApiClient} object
     */
    ...
    */
     ...
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If fail to serialize the given object
     */
     ...
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If fail to read file content from response and write to disk
     ...
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If the response has an unsuccessful status code or
     ...
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If fails to update the parameters
     */
     ...
     * @throws uk.ac.hdruk.safepeopleregistryapi.ApiException If fail to serialize the request body object into a string
     */

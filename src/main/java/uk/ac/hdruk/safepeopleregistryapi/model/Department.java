...
public class Department {
  ...
  public Department category(@javax.annotation.Nullable String category) {
  ...
  public Department createdAt(@javax.annotation.Nullable OffsetDateTime createdAt) {
  ...
  public Department updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, department.id) &&
        ...
        Objects.equals(this.category, department.category) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, category, createdAt, updatedAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "category", "created_at", "updated_at"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Department.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Department is not found in the empty JSON string", Department.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Department.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Department` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

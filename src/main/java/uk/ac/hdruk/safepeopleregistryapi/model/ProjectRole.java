...
public class ProjectRole {
  ...
  public ProjectRole id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ProjectRole createdAt(@javax.annotation.Nullable String createdAt) {
  ...
  public ProjectRole updatedAt(@javax.annotation.Nullable String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, projectRole.id) &&
        Objects.equals(this.createdAt, projectRole.createdAt) &&
        Objects.equals(this.updatedAt, projectRole.updatedAt) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "created_at", "updated_at", "name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectRole is not found in the empty JSON string", ProjectRole.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectRole.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProjectRole` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

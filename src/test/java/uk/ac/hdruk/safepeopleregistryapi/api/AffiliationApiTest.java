...
/**
 * API tests for AffiliationApi
 */
@Disabled
public class AffiliationApiTest {

    private final AffiliationApi api = new AffiliationApi();
     ...
     */
    @Test
    public void affiliationDestroyTest() throws ApiException {
        Integer id = null;
        AffiliationDestroy200Response response = api.affiliationDestroy(id);
